import 'package:artikel_berita/Providers/artikel_provider.dart';
import 'package:artikel_berita/Screens/detail_screen.dart';
...
class _ArticleScreen extends State<ArticleScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('191011400733 - Arif Setyawan'),
      ),
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => DetailScreen(
                          ...
                          description:
                              '${provider.model.results![index].description}',
                          created_at:
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                            child: Column(
                          children: [
                            Text('${provider.model.results![index].title}',
                                style: TextStyle(
                                  fontSize: 15,
